...
console.log(warehouse.addProduct('Food', 'Tomatoes', 2));
console.log(warehouse.addProduct('Food', 'Potatoes', 4));
console.log(warehouse.addProduct('Food', 'Apple', 1));
console.log(warehouse.addProduct('Drink', 'Water', 2));
console.log(warehouse.orderProducts('Food'));
console.log(warehouse.occupiedCapacity());
